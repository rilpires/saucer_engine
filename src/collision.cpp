...
void            CollisionBody::push_editor_items(){
    ...
    PROPERTY_BOOL(this,sensor); 
    PROPERTY_BOOL(this,fixed_rotation);
    ...
    PROPERTY_ENUM(this , body_type , body_type_names );
    
    // ImGui::NewLine();
    // ImGui::TextColored(ImVec4(Color(1.0f,0.0f,0.0f,1.0f)) , "To create shapes, you have to do it runtime inside scripts for now.");
}
