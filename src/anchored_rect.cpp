...
bool AnchoredRect::is_border_anchored() {
...
Vector2 AnchoredRect::get_rect_pos() {
...
Vector2 AnchoredRect::get_rect_size() {
...
bool AnchoredRect::get_starts_on_viewport() {
...
bool AnchoredRect::get_use_scene_node_transform() {
